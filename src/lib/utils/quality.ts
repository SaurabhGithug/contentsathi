/**
 * Shared Quality Check logic for ContentSathi
 * Used by internal API and generation pipeline
 */
...
export function performQualityCheck(text: string, language: string): QualityResult {
  let score = 100;
  const issues: string[] = [];
